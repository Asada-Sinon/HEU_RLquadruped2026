...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(-0.25, 0.45), lin_vel_y=(-0.10, 0.10), ang_vel_z=(-0.35, 0.35), heading=(-math.pi, math.pi)
        ),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # Real robot policy inputs: CH110 gyro/gravity, commanded velocity, joint encoders, and last actions.
        # No base linear velocity or height scan is used, because those are not reliably measurable on hardware.
...
class EventCfg:
    ...
    physics_material = EventTerm(
        ...
        params={
            ...
            "dynamic_friction_range": (0.45, 1.2),
    ...
    push_robot = EventTerm(
        ...
        params={"velocity_range": {"x": (-0.20, 0.20), "y": (-0.15, 0.15), "yaw": (-0.15, 0.15)}},
    )
...
class RewardsCfg:
    ...
    action_l2 = RewTerm(func=mdp.action_l2, weight=-0.012)
    feet_slide = RewTerm(
        func=mdp.feet_slide,
        weight=-0.15,
        params={
